...
class TestsRegistroUsuario:
    def test_modelo_Usuario_tiene_todos_los_campos_correctos(self, session):
    ...
    def test_hashear_contrasena(self, session):
    ...
    def test_verificar_contrasena(self, session):
    ...
    def test_nombre_usuario_non_nullable(self, session):
    ...
    def test_hash_contrasena_non_nullable(self, session):
